...
namespace TiketBAI
{
    public class OkindegiDepartamentu
    {
        ...
        public static List<Tiketa> Tiketairakurri()
        {
            ...
            string direktoiu = @"Data/panadeie/tickets";
                ...
                else
                {
                    ...
                    foreach (string ticket in ticketahut)
                    {
                        ...
                        try
                        {
                            ...
                            Produktu produktu = new Produktu(parts[0].Trim(), new Saltzaile(saltzailleId, saltzaileCode, saltzaileIzena), preziokiloko, pisua, totala, "panadeie");
                            ...
                            string backupnun = @"Backup/panadeie/tickets";
