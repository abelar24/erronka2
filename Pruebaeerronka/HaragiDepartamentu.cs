...
namespace TiketBAI
{
    public class HaragiDepartamentu
    {
        ...
        public static List<Tiketa> Tiketairakurri()
        {
            ...
            string direktoiu = @"Data/haragi/tickets";
                ...
                else
                {
                    ...
                    foreach (string ticket in ticketahut)
                    {
                        ...
                        try
                        {
                            ...
                            Produktu produktu = new Produktu(parts[0].Trim(), new Saltzaile(saltzailleId, saltzaileCode, saltzaileIzena), preziokiloko, pisua, totala, "haragi");
                            ...
                            string backupnun = @"Backup/haragi/tickets";
